...
CASES = [
    ...
    {"id": "repr_0_1", "x": 0.1, "tag": "representation_error", "desc": "0.1 not exact in binary64", "expected_exact": False},
    {"id": "repr_0_2", "x": 0.2, "tag": "representation_error", "desc": "0.2 not exact", "expected_exact": False},
    {"id": "repr_0_1_plus_0_2", "x": 0.1 + 0.2, "cmp": 0.3, "tag": "representation_error", "desc": "0.1+0.2 != 0.3", "expected_eq": False},
    {"id": "repr_0_3", "x": 0.3, "tag": "representation_error", "desc": "0.3 not exact", "expected_exact": False},
    ...
    {"id": "repr_0_55", "x": 0.55, "tag": "representation_error", "desc": "0.55", "expected_exact": False},
    {"id": "repr_1_005", "x": 1.005, "tag": "representation_error", "desc": "1.005", "expected_exact": False},
    {"id": "repr_4_35", "x": 4.35, "tag": "representation_error", "desc": "4.35", "expected_exact": False},
    ...
    # non-associativity
    {"id": "assoc_large_small", "tag": "non_assoc", "desc": "(1e16+1)-1e16, associativity demo", "a": 1e16, "b": 1.0, "c": -1e16},
    {"id": "assoc_sum_order", "tag": "non_assoc", "desc": "sum order matters", "vals": [1e16, 1.0, -1e16, 1.0], "expected_assoc_fail": True},

    # catastrophic cancellation
    {"id": "cancel_sqrt", "tag": "cancellation", "desc": "sqrt(x+1)-sqrt(x) loss", "x_val": 1e12},
    {"id": "cancel_quad", "tag": "cancellation", "desc": "quadratic formula cancellation", "x_val": 1e8},
    ...
    {"id": "accum_0_1_hundred", "tag": "accumulated_error", "desc": "sum([0.1]*100)", "n": 100, "step": 0.1, "expected_sum": 10.0},
    ...
    {"id": "dec_0_1_exact", "tag": "decimal_compare", "desc": "Decimal('0.1') != float(0.1)"},
    {"id": "frac_0_1_exact", "tag": "decimal_compare", "desc": "Fraction(0.1) gives binary rational"},

    # binary representation error — more decimals
    {"id": "repr_0_125", "x": 0.125, "tag": "representation_error", "desc": "0.125 = 1/8 exact", "expected_exact": True},
    {"id": "repr_0_5", "x": 0.5, "tag": "representation_error", "desc": "0.5 exact", "expected_exact": True},
    {"id": "repr_0_75", "x": 0.75, "tag": "representation_error", "desc": "0.75 exact", "expected_exact": True},
    {"id": "repr_0_1_0_1_0_1", "tag": "representation_error", "desc": "0.1+0.1+0.1", "op": "sum_three_tenths"},
    {"id": "repr_0_7", "x": 0.7, "tag": "representation_error", "desc": "0.7", "expected_exact": False},
    ...
    {"id": "div_10", "x": 1.0, "tag": "representation_error", "desc": "1.0/10.0", "divisor": 10.0, "expected_exact": False},

    # fsum vs sum
    {"id": "fsum_demo", "tag": "accumulated_error", "desc": "math.fsum vs sum", "vals": [1e16, 1.0, -1e16]},
]
